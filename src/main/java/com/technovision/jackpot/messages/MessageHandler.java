...
public class MessageHandler {
    ...
    public static String historyEntry(String playerName,String prize,String tickets,String totalTickets){
        return PLUGIN.getConfig().getString("messages.history-entry")
                .replace("{winner}",playerName)
                .replace("{prize}",prize)
                .replace("{player-tickets}",tickets)
